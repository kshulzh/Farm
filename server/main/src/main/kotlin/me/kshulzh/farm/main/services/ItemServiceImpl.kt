...
import me.kshulzh.farm.main.mappers.ItemMapper
...
class ItemServiceImpl : ItemService {
    ...
    override fun getItemById(id: String): ItemDto {
        return itemMapper.toDto(itemRepository.searchById(id) ?: throw ItemNotFoundException(id))
    }
    ...
    override fun deleteItem(id: String) {
        itemRepository.searchById(id) ?: throw ItemNotFoundException(id)
